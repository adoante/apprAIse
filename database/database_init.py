...
model_data = [
	...
	(
		"nasnet",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/nasnet",
		"https://huggingface.co/qualcomm/NASNet",
		"https://arxiv.org/abs/1707.07012",
		"https://aihub.qualcomm.com/models/nasnet?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		88.7,
		338,
