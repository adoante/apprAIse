...
chipsets_data = [
	...
	("Qualcomm X Elite", "Qualcomm", "SM8750")
]
...
benchmark_data = [
	...
	# ONNX
	(77.06, 93.25, 18, 77, 87, 'Snapdragon X Elite CRD', 'wideresnet50_quantized', 'onnx'),
	(77.12, 93.34, 4.48, 132, 128, 'Snapdragon X Elite CRD', 'wideresnet50', 'onnx'),
	(79.94, 94.77, 15, 171, 988, 'Snapdragon X Elite CRD', 'vit', 'onnx'),
	(80.68, 95.38, 11.7, 57, 654, 'Snapdragon X Elite CRD', 'swin_tiny', 'onnx'),
	(82.59, 96.23, 19.1, 100, 1176, 'Snapdragon X Elite CRD', 'swin_small', 'onnx'),
	(83.04, 96.46, 24.8, 175, 1183, 'Snapdragon X Elite CRD', 'swin_base', 'onnx'),
	(54.62, 77.93, 0.504, 0, 47, 'Snapdragon X Elite CRD', 'squeezenet1_1_quantized', 'onnx'),
	(54.83, 78.12, 0.485, 2, 71, 'Snapdragon X Elite CRD', 'squeezenet1_1', 'onnx'),
...
model_data = [
	...
	(
		"mobilenet_v3_small",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/mobilenet_v3_small",
		"https://huggingface.co/qualcomm/MobileNet-v3-Small",
		"https://arxiv.org/abs/1905.02244",
		"https://aihub.qualcomm.com/compute/models/mobilenet_v3_small?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		2.54,
		9.72,
	...
	(
		"regnet",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/regnet",
		"https://huggingface.co/qualcomm/RegNet",
		"https://arxiv.org/abs/2003.13678",
		"https://aihub.qualcomm.com/models/regnet?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		15.3,
		58.3,
	...
	(
		"regnet_quantized",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/regnet_quantized",
		"https://huggingface.co/qualcomm/RegNetQuantized",
		"https://arxiv.org/abs/2003.13678",
		"https://aihub.qualcomm.com/models/regnet_quantized?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		15.3,
		15.4,
	...
	(
		"resnet101",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnet101",
		"https://huggingface.co/qualcomm/ResNet101",
		"https://arxiv.org/abs/1512.03385",
		"https://aihub.qualcomm.com/models/resnet101?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		44.5,
		170,
	...
	# (
	# 	"resnet101quantized",
	# 	"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnet101_quantized",
	# 	"https://huggingface.co/qualcomm/ResNet101Quantized",
	# 	"https://arxiv.org/abs/1512.03385",
	# 	"https://aihub.qualcomm.com/models/resnet101_quantized?domain=Computer+Vision&useCase=Image+Classification",
	# 	"Imagenet",
	# 	"224x224",
	# 	44.5,
	# 	43.9,
	...
	# (
	# 	"resnet18",
	# 	"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnet18",
	# 	"https://huggingface.co/qualcomm/ResNet18",
	# 	"https://arxiv.org/abs/1512.03385",
	# 	"https://aihub.qualcomm.com/models/resnet18?domain=Computer+Vision&useCase=Image+Classification",
	# 	"Imagenet",
	# 	"224x224",
	# 	11.7,
	# 	44.6,
	...
	# (
	# 	"resnet18quantized",
	# 	"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnet18_quantized",
	# 	"https://huggingface.co/qualcomm/ResNet18Quantized",
	# 	"https://arxiv.org/abs/1512.03385",
	# 	"https://aihub.qualcomm.com/models/resnet18_quantized?domain=Computer+Vision&useCase=Image+Classification",
	# 	"Imagenet",
	# 	"224x224",
	# 	11.7,
	# 	11.3,
	...
	(
		"resnet50",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnet50",
		"https://huggingface.co/qualcomm/ResNet50",
		"https://arxiv.org/abs/1512.03385",
		"https://aihub.qualcomm.com/models/resnet50?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		25.5,
		97.4,
	...
	# (
	# 	"resnet50quantized",
	# 	"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnet50_quantized",
	# 	"https://huggingface.co/qualcomm/ResNet50Quantized",
	# 	"https://arxiv.org/abs/1512.03385",
	# 	"https://aihub.qualcomm.com/models/resnet50_quantized?domain=Computer+Vision&useCase=Image+Classification",
	# 	"Imagenet",
	# 	"224x224",
	# 	25.5,
	# 	25.1,
	...
	(
		"resnext101",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnext101",
		"https://huggingface.co/qualcomm/ResNeXt101",
		"https://arxiv.org/abs/1611.05431",
		"https://aihub.qualcomm.com/models/resnext101?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		88.7,
		338,
	...
	# (
	# 	"resnext101quantized",
	# 	"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnext101_quantized",
	# 	"https://huggingface.co/qualcomm/ResNeXt101Quantized",
	# 	"https://arxiv.org/abs/1611.05431",
	# 	"https://aihub.qualcomm.com/models/resnext101_quantized?domain=Computer+Vision&useCase=Image+Classification",
	# 	"Imagenet",
	# 	"224x224",
	# 	88.7,
	# 	87.3,
	...
	(
		"resnext50",
		"https://github.com/quic/ai-hub-models/blob/main/qai_hub_models/models/resnext50",
		"https://huggingface.co/qualcomm/ResNeXt50",
		"https://arxiv.org/abs/1611.05431",
		"https://aihub.qualcomm.com/models/resnext50?domain=Computer+Vision&useCase=Image+Classification",
		"Imagenet",
		"224x224",
		88.7,
		87.3,
...
def create_db():
	...
	with Session(engine) as session:
		...
		for benchmark in benchmark_data:
			...
			model = session.exec(select(Model).where(Model.model_name == benchmark[6])).first()
